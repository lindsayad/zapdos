...
template <>
InputParameters
validParams<ElectronImpactReaction>()
{
...
ElectronImpactReaction::ElectronImpactReaction(const InputParameters & parameters)
  : Kernel(parameters),
    ...
    _alpha_iz(getMaterialProperty<Real>("alpha_ex")),
...
ElectronImpactReaction::~ElectronImpactReaction() {}

Real
ElectronImpactReaction::computeQpResidual()
{
...
Real
ElectronImpactReaction::computeQpJacobian()
{
  return 0.0;
}

Real
ElectronImpactReaction::computeQpOffDiagJacobian(unsigned int jvar)
{
